...
const funnel = vi.hoisted(() => ({
  impl: async () => ({ n_swept: 100, n_judged: 80, n_go: 1, n_marginal: 9, n_no_go: 70, n_promoted: 40, n_live: 5 }),
}))
vi.mock('@/lib/funnel', () => ({
...
describe('/opengraph-image', () => {
  ...
  it('renders the live promoted-bot count from getFunnelCounts', async () => {
    funnel.impl = async () => ({ n_swept: 100, n_judged: 80, n_go: 1, n_marginal: 9, n_no_go: 70, n_promoted: 40, n_live: 5 })
    await Image()
