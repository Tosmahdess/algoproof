...
export const BOT_PARAMS: Record<string, BotParams> = {
  "v1-spot": {
    groups: [
      ...
      },
      {
        ...
        items: [
          { label: "Risque par trade", value: "1 %", note: "0,5 % en drawdown" },
          { label: "Min R:R", value: "1 : 2" },
          { label: "Stop loss", value: "ATR × 2.0", note: "initial, suit le prix en profit sur BTC / SOL / ADA" },
          { label: "Take profit", value: "50 % / 30 % / 20 %", note: "TP1 → breakeven → TP2 → runner" },
          { label: "Positions max", value: "3 simultanées" },
          { label: "Risque quotidien max", value: "3 %" },
        ],
      },
      {
        title: "Filets de sécurité",
        items: [
          { label: "Filtre météo du marché", value: "Actif", note: "bloque les entrées quand le macro est jugé instable (VIX / F&G / funding)" },
          { label: "Coupe-circuit", value: "−5 %/jour", note: "arrêt automatique et alerte Telegram" },
          { label: "Pause automatique", value: "3 pertes → pause de 4 h" },
        ],
      },
      {
        title: "Coûts",
        items: [
          { label: "Plateforme", value: "Kraken Spot", note: "depuis le 30 juin 2026 (départ Binance FR / MiCA)" },
          { label: "Frais taker", value: "0,26 %" },
          { label: "Slippage estimé", value: "0,10 %" },
          { label: "Coût aller-retour", value: "~0,70 %" },
        ],
      },
    ],
    technicalArticle: [
  ...
  "v1-spot-shadow": {
    groups: [
      ...
      {
        title: "Filets de sécurité (relâchés)",
        items: [
          { label: "Filtre météo du marché", value: "Actif", note: "bloque les entrées quand le macro est jugé instable" },
      ...
      },
      {
        title: "Coûts",
        items: [
          { label: "Plateforme", value: "Binance Spot (simulation, données Binance)" },
          { label: "Frais taker", value: "0,10 %" },
          { label: "Coût aller-retour", value: "~0,40 %" },
        ],
      },
    ],
    technicalArticle: [
      ...
      {
        title: "Filtre de sécurité (veille de marché)",
        body: "Identique à la version standard : avant chaque entrée, le service de veille de marché évalue le régime macro via 4 piliers (sentiment, dérivés, news, macro). La seule différence est le comportement en régime ORANGE : le bot laisse les positions courir plus longtemps avant de remonter le stop au breakeven.",
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { label: "Risque par trade", value: "1 %", note: "0,5 % en drawdown" },
          { label: "Min R:R", value: "1 : 2" },
          { label: "Stop loss", value: "ATR × 2.0", note: "suit le prix en profit sur BTC / SOL / ETH / XRP / ADA" },
          { label: "Take profit", value: "50 % / 30 % / 20 %", note: "TP1 → breakeven → TP2 → runner" },
          { label: "Positions max", value: "3 simultanées" },
          { label: "Risque quotidien max", value: "3 %" },
        ],
      },
      {
        title: "Filets de sécurité",
        items: [
          { label: "Filtre météo du marché", value: "Actif", note: "is_safe et is_macro_safe requis tous les deux" },
          { label: "Coupe-circuit", value: "−5 %/jour", note: "arrêt automatique et alerte Telegram" },
          { label: "Pause automatique", value: "3 pertes → pause de 4 h" },
        ],
      },
      {
        title: "Coûts",
        items: [
          { label: "Plateforme", value: "Hyperliquid Perps" },
          { label: "Frais taker", value: "0,065 %", note: "plus bas que la plupart des CEX" },
          { label: "Slippage estimé", value: "0,02 %" },
          { label: "Coût aller-retour", value: "~0,15 %" },
        ],
      },
    ],
    technicalArticle: [
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "ADX(14) > 20 + EMA direction" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "10 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
        items: [
          { label: "Risque par trade", value: "1 %" },
          { label: "Stop loss", value: "ATR(14) × 2.0" },
          { label: "Take profit", value: "R:R 1:2", note: "TP = 2 × distance du SL" },
          { label: "Positions max", value: "8 simultanées" },
          { label: "Risque quotidien max", value: "3 %" },
        ],
      },
      {
        title: "Filets de sécurité",
        items: [
          { label: "Filtre météo du marché", value: "Actif", note: "bloque les entrées quand la météo est au rouge" },
          { label: "Coupe-circuit", value: "−3 %/jour" },
          { label: "Pause automatique", value: "5 pertes → pause de 4 h" },
        ],
      },
      {
        title: "Coûts",
        items: [
          { label: "Plateforme", value: "Binance Futures Perps (simulation, données Binance)" },
          { label: "Frais taker", value: "0,05 %" },
          { label: "Slippage estimé", value: "0,05 %" },
          { label: "Coût aller-retour", value: "~0,20 %" },
        ],
      },
    ],
    technicalArticle: [
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "ATR Channel(SMA 14, ATR×2.0) breakout" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "26 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "BB(20, 2.5σ) squeeze + expansion" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "10 (BF perps)" },
        ],
      },
  ...
  "emacross-slope-bf6": {
    groups: [
      ...
      },
      {
        title: "Filets de sécurité",
        items: [
          { label: "Filtre météo du marché", value: "Actif" },
          { label: "Coupe-circuit", value: "−5 %/jour" },
          { label: "Pause automatique", value: "3 pertes → pause de 4 h" },
        ],
      },
      {
        title: "Coûts",
        items: [
          { label: "Plateforme", value: "Binance Futures (simulation, données Binance)" },
          { label: "Frais taker", value: "0,05 %" },
          { label: "Coût aller-retour", value: "~0,10 %" },
        ],
      },
    ],
    technicalArticle: [
    ...
    groups: [
      {
        ...
        items: [
          { label: "Entrée", value: "EMA 21 × EMA 55", note: "direction confirmée par l'EMA 200" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "SOL / LINK / DOGE", note: "Binance Spot" },
          { label: "Direction", value: "Long uniquement" },
        ],
      },
      {
        ...
        items: [
          { label: "Risque par trade", value: "1 %" },
          { label: "Stop loss", value: "H1 ATR × mult", note: "SL plus serré que l'ATR H4 sur les actifs volatils" },
          { label: "Positions max", value: "3 simultanées" },
        ],
      },
      {
  ...
  "breakout-hl-sol": {
    groups: [
      ...
      },
      {
        title: "Filets de sécurité",
        items: [
          { label: "Filtre météo du marché", value: "Actif", note: "vérifié à chaque ouverture de session" },
          { label: "Coupe-circuit", value: "−3 %/jour" },
          { label: "Pause automatique", value: "5 pertes → pause de 4 h" },
        ],
      },
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Chandelier Exit (period=14, mult=3.0)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "14 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "BB(20, 2.5σ) breakout + RSI(21)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "9 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "EMA(9>21) + RSI(14)>50 + MACD bullish" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "11 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Ichimoku TK cross + RSI(14)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "12 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "SuperTrend(7, 2.0) + MACD(8/21/5)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "11 (BF perps)" },
        ],
      },
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Donchian Channel(10) breakout" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "17 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "EMA(9) × EMA(50)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "9 (POL, SEI, DOT, XRP, SOL, AVAX, ATOM, FIL, HBAR)" },
        ],
      },
      {
        title: "Gestion du risque",
  ...
  "emacross-bf7-x10": {
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "EMA(21) × EMA(100)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "7 (BTC, POL, RENDER, SOL, SEI, ARB, DOT)" },
          { label: "Levier", value: "×10", note: "levier de la plateforme" },
        ],
      },
      {
        title: "Gestion du risque",
        items: [
          ...
          { label: "Stop loss", value: "ATR(14) × 1.5", note: "plus serré pour contrôler le levier" },
          { label: "Take profit", value: "R:R 1:2" },
          { label: "Positions max", value: "4 simultanées" },
          { label: "Max daily DD", value: "−5 %", note: "coupe-circuit" },
        ],
      },
      {
        title: "Filets de sécurité",
        items: [
          { label: "Filtre météo du marché", value: "Actif", note: "contrôle le multiplicateur de levier" },
          { label: "MI = RED", value: "×0", note: "aucune nouvelle entrée" },
          { label: "Coupe-circuit", value: "−5 %/jour" },
          { label: "Pause automatique", value: "5 pertes → pause de 4 h" },
        ],
      },
    ...
    technicalArticle: [
      ...
      {
        title: "Gestion du risque : modulée par la veille de marché",
        body: "Le risk sizing est radicalement différent des autres bots : le risque par trade est modulé par le régime de veille de marché plutôt que fixé. Risque de base = 0,5 % du capital, multiplié par un facteur de veille de marché : ×5 en régime GREEN (= 2,5 % par trade), ×3 en régime YELLOW (= 1,5 %), ×2 en régime ORANGE (= 1,0 %), ×0 en régime RED (= aucune entrée). Le stop loss est plus serré que la moyenne (ATR×1.5 vs ATR×2.0 standard) pour limiter l'exposition réelle malgré le levier ×10. Le maximum de positions simultanées est plafonné à 4 (vs 8 sur les bots standard) pour contrôler le risque agrégé. Daily DD kill switch à −5 %.",
    ...
    groups: [
      {
        ...
        items: [
          { label: "Entrée", value: "EMA(9) × EMA(50)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Asset", value: "EUR/USD", note: "actif unique, OANDA" },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Stop loss", value: "ATR(14) × 2.0" },
          { label: "Take profit", value: "R:R 1:2" },
          { label: "Positions max", value: "2 simultanées" },
          { label: "Risque quotidien max", value: "3 %" },
        ],
      },
      {
        title: "Filets de sécurité",
        items: [
          { label: "Filtre météo du marché", value: "Actif", note: "même service que crypto bots" },
          { label: "Coupe-circuit", value: "−3 %/jour" },
          { label: "Pause automatique", value: "5 pertes → pause de 4 h" },
        ],
      },
      {
        ...
        items: [
          ...
          { label: "Spread", value: "~0,01 %", note: "par côté" },
          { label: "Coût aller-retour", value: "~0,02 %" },
        ],
      },
    ],
    technicalArticle: [
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "EMA Ribbon (5/13/34/89) aligned" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "17 (BF perps)" },
        ],
      },
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "HeikinAshi 3 bougies consécutives" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "28 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "HMA(20) × HMA(100)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "22 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Ichimoku TK cross + cloud" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "25 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "KAMA(10, 2, 30) cross" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "26 (BF perps)" },
        ],
      },
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Keltner Channel breakout" },
          { label: "Parameters", value: "EMA 20, ATR×1.5" },
          { label: "Unité de temps", value: "H4" },
          { label: "Asset", value: "XAU-USDC", note: "perp or sur Hyperliquid" },
        ],
      },
      {
        title: "Gestion du risque",
      ...
      },
      {
        title: "Filets de sécurité",
        items: [
          { label: "Filtre météo du marché", value: "Actif", note: "bloque les entrées en régime rouge" },
          { label: "Coupe-circuit", value: "−3 %/jour" },
          { label: "Pause automatique", value: "5 pertes → pause de 4 h" },
        ],
      },
    ...
    technicalArticle: [
      {
        ...
        body: "Le bot trade le Keltner Channel(period=20, multiplicateur=1.5×ATR) sur H4, appliqué à un seul actif : le perp XAU-USDC sur Hyperliquid. Une entrée long se déclenche quand le close casse au-dessus de la borne supérieure (EMA 20 + 1.5×ATR), un short quand il casse sous la borne inférieure (EMA 20 - 1.5×ATR). L'or réagit à des drivers macro distincts du crypto : dollar (DXY), taux réels US, sentiment risk-off. Cela en fait un actif décorrélé intéressant pour diversifier un portefeuille de bots. Ce bot n'est pas encore qualifié. Le backtest d'origine a tourné avec un stop à 1,5×ATR, un take profit à 3×ATR et un ATR calculé autrement, alors que le bot déployé travaille à 2×ATR et 4×ATR. Il mesure donc une autre stratégie que celle qui passe les ordres. Le chiffre de performance que j'avais noté pour ce bot sort de ce run-là, donc je n'en publie aucun. Tant que je ne l'ai pas repassé en entier, validation hors échantillon incluse, il n'y a rien de mesuré à montrer.",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Keltner Channel(EMA 14, ATR×1.5) breakout" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "26 (BF perps)" },
        ],
      },
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "MACD(12/26/9) + Volume" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "11 (BF perps)" },
        ],
      },
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "SMA(10) × SMA(30)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "10 (BF perps)" },
        ],
      },
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Opening Range Breakout (H1)" },
          { label: "Unité de temps", value: "H1" },
          { label: "Actifs", value: "~24 perpétuels Hyperliquid" },
        ],
      },
      {
        title: "Gestion du risque",
        items: [
          ...
          { label: "Positions max", value: "6 simultanées" },
          { label: "Risque quotidien max", value: "3 %" },
        ],
      },
      {
      ...
      },
      {
        title: "Coûts",
        items: [
          { label: "Plateforme", value: "Hyperliquid Perps", note: "le live tourne sur Hyperliquid" },
          { label: "Frais taker", value: "0,065 %" },
          { label: "Slippage estimé", value: "0,05 %" },
          { label: "Coût aller-retour", value: "~0,23 %" },
        ],
      },
    ],
    technicalArticle: [
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "ROC(25) zero cross" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "12 (BF perps)" },
        ],
      },
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "RSI(14) divergence (10-bar)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "6 (LINK, ATOM, UNI, LTC, BCH, TON)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "TEMA(20) × TEMA(100)" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "10 (BF perps)" },
        ],
      },
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "TSI(40, 20) zero/signal cross" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "8 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "TTM Squeeze (BB×KC) + momentum" },
          { label: "Unité de temps", value: "H4" },
          { label: "Actifs", value: "7 (BF perps)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Williams VolBreakout (D1)" },
          { label: "Unité de temps", value: "D1" },
          { label: "Actifs", value: "28 (BF perps)" },
        ],
      },
      {
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Williams VolBreak D1 + ORB H1" },
          { label: "Unité de temps", value: "H1 + D1" },
          { label: "Actifs", value: "7 (AVAX, BTC, DOGE, GALA, HBAR, SEI, SOL)" },
        ],
      },
      {
        title: "Gestion du risque",
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "Keltner H4 + EMA(100) D1" },
          { label: "Unité de temps", value: "H4 + D1" },
          { label: "Actifs", value: "22 (BF perps)" },
        ],
      },
      {
    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: "Range",      value: "±8 % du prix",    note: "ex : 73 600 à 86 400 (BTC=80 000)" },
    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: "Unité de temps", value: "D1", note: "rééquilibrage hebdomadaire (7j)" },
        ],
      },
      {
    ...
    groups: [
      {
        title: "Signal",
        items: [
          { label: "Entrée", value: "EMA 21 × EMA 55", note: "bougies H4" },
          { label: "Unité de temps", value: "H4" },
          { label: "Direction", value: "Long/short" },
          { label: "Actifs", value: "6", note: "ATOM, ETH, GALA, HBAR, OP, SEI" },
        ],
      },
      {
        title: "Filtres",
