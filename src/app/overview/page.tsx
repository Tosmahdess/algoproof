  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-12">
      ...
      <JsonLd data={faqJsonLd([
        ...
        { question: 'Le trading est-il en argent réel ?', answer: 'La plupart des bots sont en paper trading (simulation fidèle). Les bots qui tournent avec mon argent sont marqués « Argent réel ».' },
      ])} />
