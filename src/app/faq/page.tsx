...
const FAQ = [
  ...
  { question: 'Les bots sont-ils en argent réel ?', answer: 'La plupart tournent en paper trading (simulation fidèle sur de vraies données, sans argent réel). Les bots qui tournent avec mon argent sont marqués « Argent réel ». Le statut est toujours affiché, sur mobile aussi.' },
