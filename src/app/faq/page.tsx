...
const FAQ = [
  ...
  { question: 'Pourquoi les configurations sont-elles payantes si tout le reste est public ?', answer: 'Parce que ce sont deux choses différentes. Voir un bot trader ne permet de rien reproduire : il faut la configuration exacte, les filtres, et le dossier qui montre comment elle a été validée contre les milliers de voisines qui sont mortes. C\'est ça que je vends, et une stratégie complète est ouverte en entier, gratuitement, pour que tu voies à quoi ressemble un dossier avant de payer quoi que ce soit.' },
