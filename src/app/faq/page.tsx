...
const FAQ = [
  ...
  { question: 'Qu\'est-ce qui est payant ?', answer: 'La règle tient en une ligne : ce que je fais reste gratuit, comment je l\'ai fait se paie. Pour les bots sortis du moteur, voir un bot trader ne permet de rien reproduire ; il faut les paramètres exacts, les filtres, et le dossier qui montre comment cette configuration a été retenue contre les milliers de voisines qui sont mortes. Mes bots en argent réel, eux, publient leurs paramètres sur leur fiche. Sur les sociétés, la règle est la même : la note, le verdict et sa raison, les chiffres et les comptes sont ouverts sur les sociétés que je note, et ce que les membres achètent, ce sont deux paragraphes d\'analyse par société : ce que ses chiffres veulent dire pour son métier, et ce qui peut mal tourner. S\'ajoute l\'outil lui-même, le labo, avec ses grilles et ses tests de robustesse. Les trades, les pertes et les courbes restent publics et gratuits, et un dossier complet, celui de l\'EMA cross, est ouvert en entier pour que tu voies à quoi ça ressemble avant de payer quoi que ce soit.' },
