...
const FAQ = [
  ...
  { question: 'Qu\'est-ce qui est payant ?', answer: 'L\'adhésion porte sur la configuration exacte des bots et sur leur dossier de validation, jamais sur leurs résultats. Voir un bot trader ne permet de rien reproduire : il faut les paramètres exacts, les filtres, et le dossier qui montre comment cette configuration a été retenue contre les milliers de voisines qui sont mortes. Les trades, les pertes et les courbes restent publics et gratuits, et une stratégie complète est ouverte en entier pour que tu voies à quoi ressemble un dossier avant de payer quoi que ce soit.' },
