...
export default function EmailCapture({
  ...
  description = 'Je publie mes backtests, mes rejets et les évolutions du labo. Laisse ton email pour recevoir les prochains articles d’analyse. Pas de spam, désinscription sur simple réponse.',
}: Props) {
