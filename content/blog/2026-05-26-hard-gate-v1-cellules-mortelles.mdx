---
title: "J'ai perdu 368 USDT en simulation en 9 jours. Voici comment j'ai trouvé les 4 cellules mortelles de ma matrice MI"
date: "2026-05-26"
category: "methode"
...
Sur les 9 jours suivants (17 → 26 mai), 200 nouveaux trades fermés. **P&L net : −368 USDT en simulation.** Pas un crash, pas un bug — un retournement de régime que mon filtre n'avait pas anticipé. Les shorts continuaient de saigner, les longs prenaient des SL gros et des TP serrés. La matrice MI v1 voyait bien le régime BEAR mais ne bloquait rien — elle réduisait le sizing, c'est tout.

Cette session, j'ai passé une journée à comprendre exactement **où** se trouvaient les fuites, et à construire un filtre qui les ferme dur. Le résultat : un module que j'ai déployé en observation, sans qu'il puisse encore bloquer quoi que ce soit, baptisé **Hard-Gate v1**. Si je l'avais eu en place le 17 mai, le backtest dit que j'aurais fait **+59 USDT** sur la fenêtre au lieu de **−368** — un delta de **+427 USDT** sur la même fenêtre de 9 jours, que je n'ai pas mesuré sur du live mais sur un re-jeu walk-forward de chaque trade existant.
...
Surprise. Indépendamment du régime de marché, **un bot qui vient de prendre 3 SL d'affilée a 26 % de chances de gagner le 4ème**, contre 50 % pour un bot "frais". C'est massif : sur les 147 occurrences observées, ce 4ème trade a coûté en moyenne −3.24 €. Cumul : **−476 USDT** en simulation, soit autant que la cellule TRANSITION du bucket MI.
...
Le gate sauve l'écosystème surtout sur la fenêtre la plus récente. Sur les 5 derniers jours (mon **OOS true** dans le walk-forward 70/30) : baseline −368 USDT en simulation → gate **+59 USDT**. Sans cherry-picking ni look-ahead.
