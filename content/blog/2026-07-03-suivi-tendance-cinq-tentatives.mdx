...
**Les chiffres faciles mentent.** Paper, live sans frais, in-sample : tout gonfle. La seule question qui compte, c'est ce que ça donne sur deux ans, frais réels, sur des données que je n'ai pas choisies après coup.

**« Ça marche dans tel cas » est presque toujours un mirage.** J'ai passé trois soirées sur une anomalie qui donnait l'illusion d'un edge dans les marchés sans direction. En regardant barre par barre, l'edge apparent n'était qu'un artefact de frais et d'attribution. Je ne l'aurais jamais vu dans le résumé.

**Une bonne idée qui dépend d'un seul actif n'est pas une bonne idée.** La fusion mourait en retirant GALA. Le vrai test d'une stratégie, ce n'est pas sa meilleure performance, c'est sa solidité quand on lui enlève ses béquilles.

## Alors, le suivi de tendance est mort ?

Non. Ces stratégies imprimaient en 2024 et 2025, quand le marché tenait des tendances. Le problème n'est pas l'idée, c'est qu'elle ne franchit pas mon seuil comme produit déployable sur la période complète, et que je refuse de livrer quelque chose qui ne marche que si je choisis les gagnants après la bataille. Ce serait facile de te vendre l'une de ces cinq tentatives avec son plus beau chiffre. Je préfère te montrer les cinq non, avec les vrais chiffres, et les ranger au cimetière. C'est moins vendeur. C'est plus honnête. Et à long terme, c'est la seule chose qui vaut quelque chose.
