...
<StatRow>
  ...
  <Stat label="P&L cumulé (argent réel)" value="+3,44 €" subtext="depuis le début, rodage inclus" />
</StatRow>
...
Le cumulé depuis le début (rodage compris) tient à +3,44 €, c'est-à-dire à rien du tout : une semaine comme celle-ci l'efface. Une mauvaise semaine ne remet pas en cause une stratégie, elle l'interroge.
...
- **Tenir le cap sur le cumulé** : +3,44 € depuis le début, autant dire zéro. La priorité reste de ne pas laisser une mauvaise semaine déclencher des ajustements précipités.